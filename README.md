...
- **Множественные DNS-резолверы** — Cloudflare, Google, Quad9, AdGuard, OpenDNS, Яндекс, NextDNS, Mullvad
...
4. Нажмите «Выполнить Dig»

### Выбор DNS-резолвера
В секции «DNS-резолверы» выберите:
- **Default** — резолвер по умолчанию
- **Preset** — предустановленные (Cloudflare, Google, Quad9, AdGuard, OpenDNS, Яндекс, NextDNS, Mullvad)
- **Authoritative** — авторитативные серверы домена
- **Custom** — собственные серверы

### Дополнительные опции
Нажмите на чекбоксы справа от кнопки «Выполнить Dig»:
- **Команда** — показать dig команду
- **Трассировка** — показать путь от корневых серверов
- **Whois** — показать информацию о домене
