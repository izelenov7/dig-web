...
- **Информация о владельце IP** — автоматическое определение владельца IP-адреса домена
...
После выполнения DNS-запроса сервис автоматически отображает блок с информацией о владельце IP-адреса:
- **IP-адрес** — адрес, на который направлен домен
- **Владелец** — название организации или провайдера
- **ASN** — номер автономной системы (например, AS15169)
- **Страна** — код страны (например, US, DE, RU)

Блок отображается внизу страницы результатов после загрузки данных из публичных WHOIS API (RIPE, ip-api.com).
